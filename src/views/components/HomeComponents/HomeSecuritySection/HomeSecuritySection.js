        ...
        <div className='securityBg'>
            <div className='col-10 mx-auto py-lg-5'>
                <div className=' row'>
                    ...
                    <div className='col-lg-6 my-auto text-md-start  text-center' data-aos="fade-up-right">
                    ...
                    <div className='col-lg-6 mt-5' data-aos="fade-up-left">
                    ...
                    <div className='col-lg-6 mt-sm-5 mt-lg-0 mt-4 text-md-start  mb-5 text-cente d-block d-lg-none'>
                    ...
                    <div className='col-lg-6 text-center flex-md-row-reverse mb-5 mb-lg-0' data-aos="fade-up-right">
                    ...
                    <div className=' col-lg-6  d-flex justify-content-center  align-items-center' data-aos="fade-up-left">
