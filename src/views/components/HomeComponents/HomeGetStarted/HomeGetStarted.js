    ...
    return (
        ...
        <div className='getStartedBg py-5'>
            <div className='col-10 mx-auto'>
                ...
                <h1 className='paymentsAllTitle  text-center my-3' data-aos="zoom-in">Get Started in Minutes</h1>

                <div className=' d-md-flex justify-content-around mt-5' data-aos="fade-up">
